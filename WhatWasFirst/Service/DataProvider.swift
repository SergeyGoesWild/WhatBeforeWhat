...
enum TitlesSpecific: String {
    ...
    var localized: (String, String) {
        ...
        case .temple: return (UIStrings.string("Title.temple"), "🕯️")
        ...
        case .neoClassical: return (UIStrings.string("Title.neoClassical"), "🏛️")
        ...
        case .antiquity: return (UIStrings.string("Title.antiquity"), "🏛️")
        case .victorian: return (UIStrings.string("Title.victorian"), "🫖")
        case .paris: return (UIStrings.string("Title.paris"), "⚜️")
        ...
        case .asian: return (UIStrings.string("Title.asian"), "⛩️")
