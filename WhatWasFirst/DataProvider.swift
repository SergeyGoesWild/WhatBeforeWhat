...
final class DataProvider {
    ...
    let data: [HistoricItem] = [
        ...
        HistoricItem(id: UUID(), picture: "FlatironBuilding", date: 1902, flavourText: "The Flatiron Building is a steel-framed skyscraper known for its triangular shape and iconic NYC status.", circa: false),
        ...
        HistoricItem(id: UUID(), picture: "PaleoliticFlute", date: -43000, flavourText: "The Paleolithic Flute is one of the world’s oldest instruments, carved from bone to create early music.", circa: true),
        ...
        HistoricItem(id: UUID(), picture: "AmbassadeursLautrec", date: 1892, flavourText: "Toulouse-Lautrec’s poster for Ambassadeurs captures the vivid energy of Parisian nightlife and cabaret.", circa: false),
        ...
        HistoricItem(id: UUID(), picture: "WedgwoodUrn", date: 1800, flavourText: "This Wedgwood urn reflects neoclassical elegance in ceramics, blending art, science, and industry.", circa: true),
        ...
        HistoricItem(id: UUID(), picture: "CupidDrivingChariot", date: 1800, flavourText: "This elegant artwork shows Cupid in motion, reflecting neoclassical fascination with myth and movement.", circa: true),
        HistoricItem(id: UUID(), picture: "MercuryPajou", date: 1780, flavourText: "Pajou’s Mercury is a dynamic neoclassical sculpture that captures the Roman god’s grace and swiftness.", circa: false),
        HistoricItem(id: UUID(), picture: "ThreeGraces", date: 1817, flavourText: "The Three Graces is a sculpture celebrating beauty, charm, and creativity from classical mythology.", circa: false),
        ...
        HistoricItem(id: UUID(), picture: "MycenaeanVase", date: -1100, flavourText: "This Mycenaean vase showcases early Greek pottery styles, linking utility with artistic expression.", circa: true),
        ...
        HistoricItem(id: UUID(), picture: "LycurgusCup", date: 370, flavourText: "The Lycurgus Cup is a Roman glass marvel that changes color with light, showing ancient ”nanotech”.", circa: true),
        ...
        HistoricItem(id: UUID(), picture: "RasTransformation", date: -350, flavourText: "This ancient Egyptian image depicts the sun god Ra’s journey through the underworld’s twelve hours.", circa: true),
        HistoricItem(id: UUID(), picture: "VenusHohleFels", date: -40000, flavourText: "The Venus of Hohle Fels is one of the oldest known figurines, symbolizing fertility and early art.", circa: true),
        HistoricItem(id: UUID(), picture: "GavleGoat", date: 2011, flavourText: "The Gävle Goat is a Swedish holiday tradition often targeted by arson in a bizarre festive ritual.", circa: false),
    ]
